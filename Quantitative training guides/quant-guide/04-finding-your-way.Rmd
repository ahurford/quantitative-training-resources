...
R studio has 4 windows (also known as "panes") that are inter-linked. The default layout is shown in Figure 5.1. You can mover the layout of the panes and change their size and shape by clicking and dragging with your mouse along the window pane borders. The details of what happens in each pane are detailed below.

```{r fig.align='center', echo=FALSE, message=FALSE, out.width="65%"}
...
This tab gives you access to the file directory on your own computer. It's a useful spot to set your working directory (see chapter 6).
...
This lets you get help with R functions. Type the name of the function in the search window (blank bar with the magnifying glass beside it). See chapter 9 "Getting R help" for more details.
