...
knitr::include_graphics("./figures/Fig5.1")
```
...
This lets you get help with R functions. Type the name of the function in the search window (blank bar with the magnifying glass beside it)
